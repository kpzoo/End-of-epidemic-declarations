% Probability an epidemic is eliminated with imports
function [z, zseq, z1, zseq1, Rcurr] = getProbEliminSI(k, I, Ilam, priors, Pomega)

% Assumptions and notes
% - I can be local or total number of cases
% - Ilam is always total number of cases (with imports)
% - SI distribution included directly
